        ...
        <form action="{{ route('isler.store') }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="isveren_telefon" name="isveren_telefon" class="form-control {{ $errors->has('isveren_telefon') ? 'input-error' : '' }}"
                           value="{{ old('isveren_telefon') }}" placeholder="0532 000 00 00">
